...
const testimonials = [
  {
    id: 1,
    name: 'Екатерина М.',
    text: 'Обожаю этот салон! Хожу сюда уже третий год. Мастера настоящие профессионалы, всегда знают, что мне нужно. Особенно благодарна за мой идеальный маникюр!',
    rating: 5,
  },
  {
    id: 2,
    name: 'Марина С.',
    text: 'Готовилась к свадьбе в этом салоне — и не пожалела! Сделали шикарную причёску и макияж, которые держались весь день. Получила массу комплиментов!',
    rating: 5,
  },
  {
    id: 3,
    name: 'Александра К.',
    text: 'Лучший салон в Тольятти! Девочки делают так, что маникюр держится по 3-4 недели. Очень стерильно, приятная атмосфера, всегда угощают чаем.',
    rating: 5,
  },
];
